<%-- 
    Document   : tablaFactura
    Created on : 4/09/2021, 04:34:22 PM
    Author     : luis
--%>
            ...
            <section>
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        <h1 class="text-center">Consulta de Factura de un Cliente</h1>
                        <a class="btn btn-success" href="Servlet-CounstaVenta?accion=factura">Regresar</a>
                        <br>
                        <br>
                    ...
                    <% 
                        ...
                        List<Reporte>list=dao.Factira(ServletCounstaVenta.numeroFacturaFinal);
