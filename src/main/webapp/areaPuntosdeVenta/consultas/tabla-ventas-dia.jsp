<%-- 
    Document   : tabla-ventas-dia
    Created on : 4/09/2021, 05:10:28 PM
    Author     : luis
--%>
            ...
            <section>
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        <h1 class="text-center">Consulta de Ventas del Dia</h1>
                        <br>
                        <br>
                    ...
                    <% 
                        ...
                        List<Reporte>list=dao.ventasDia();
                    ...
                    <tr>
                        ...
                        <th class="text-center" class="text-black-50"><%=reporte.getPerdida()%></th>
