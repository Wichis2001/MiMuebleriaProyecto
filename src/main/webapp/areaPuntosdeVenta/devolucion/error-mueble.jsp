<%-- 
    Document   : error-mueble
    Created on : 2/09/2021, 07:40:54 PM
    Author     : luis
--%>
            ...
            <section>
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        ...
                        <p class="text-center">Este mueble ya ha sido devuelto</p>
                            <div class="ewk_cont_banner_link">
                            <a class="ewk_banner_link" href="Servlet-Factura?accion=listar">REGRESAR</a>
                            </div>
                    </div>
                </div>
            </section>
