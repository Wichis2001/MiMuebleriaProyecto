<%-- 
    Document   : consulta-muebles
    Created on : 30/08/2021, 03:36:03 PM
    Author     : luis
--%>
            ...
            <section>
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        ...
                        <a class="btn btn-success" href="Servlet-Consulta?accion=listar6">Ordenar menor a mayor</a>
                        <br>
                        <br>
                    ...
                    <%
                        //Creamos un nuevo dao de listar mueble para poder agregar todos nuestros objetos de mueble dentro de nuestra tabla
