<%-- 
    Document   : reporte-usuarios-ventas
    Created on : 5/09/2021, 01:39:35 AM
    Author     : luis
--%>
            ...
            <section>
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        <h1 class="text-center">REPORTE DE USUARIO CON MAŚ VENTAS</h1>
                        <form action="Servlet-Reportes?accion=reporteCompra">
                            ...
                            <input id="agregar" class="btn btn-primary" class="text-center" type="submit" name="accion" value="Consultar Usuario"><br>
                        </form>
                    </div>
                </div>
            </section>
