<%-- 
    Document   : reporte-mueble-mas-tabla
    Created on : 5/09/2021, 04:46:18 AM
    Author     : luis
--%>
            ...
            <section>
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        <h1 class="text-center">REPORTE MUEBLE MAŚ VENDIDO</h1>
                        <a class="btn btn-success" href="Servlet-Reportes?accion=mmas">Regresar</a>
                        <br>
                        <br>
                    ...
                    <% 
                        ...
                        List<Reporte>list=dao.mueble(dao.nombreMuebleMas(ServletReportes.fechaInicio, ServletReportes.fechaFinal),ServletReportes.fechaInicio, ServletReportes.fechaFinal);
                ...
                <br>
                        <form class="form-group d-flex">
                            ...
                            <input class="col-sm-2 d-flex" class="text-center" type="text" value="<%=dao.nombreMuebleMas(ServletReportes.fechaInicio, ServletReportes.fechaFinal)%>" disabled="disabled"><br>
                        </form>
                <br>
                ...
                <script>
                    ...
                    btnExportToCsv.addEventListener("click", () => {
                        ...
                        anchorElement.download = "reporte-mueble-mas-vendido.csv";
                        anchorElement.click();
