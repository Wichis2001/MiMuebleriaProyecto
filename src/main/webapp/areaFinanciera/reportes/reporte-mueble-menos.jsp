<%-- 
    Document   : reporte-mueble-menos
    Created on : 5/09/2021, 04:58:30 AM
    Author     : luis
--%>
                ...
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        ...
                        <form action="Servlet-Reportes?accion=reporteCompra">
                            ...
                            <input id="agregar" class="btn btn-primary" class="text-center" type="submit" name="accion" value="Consultar Mueble Vendido"><br>
                        </form>
                    </div>
                </div>
            </section>
