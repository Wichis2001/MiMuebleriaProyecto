<%-- 
    Document   : reporte-mueble-mas
    Created on : 5/09/2021, 04:46:05 AM
    Author     : luis
--%>
            ...
            <section>
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        <h1 class="text-center">REPORTE MUEBLE MÁS VENDIDO</h1>
                        <form action="Servlet-Reportes?accion=reporteCompra">
                            ...
                            <input id="agregar" class="btn btn-primary" class="text-center" type="submit" name="accion" value="Consultar Mueble"><br>
                        </form>
                    </div>
                </div>
            </section>
