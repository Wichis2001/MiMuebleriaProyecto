<%-- 
    Document   : reporte-usuarios-ganancias
    Created on : 5/09/2021, 04:20:43 AM
    Author     : luis
--%>
            ...
            <section>
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        <h1 class="text-center">REPORTE DE USUARIO CON MAŚ GANANCIAS</h1>
                        <form action="Servlet-Reportes?accion=reporteCompra">
                            ...
                            <input id="agregar" class="btn btn-primary" class="text-center" type="submit" name="accion" value="Consultar Usuario Ganancia"><br>
                        </form>
                    </div>
                </div>
            </section>
