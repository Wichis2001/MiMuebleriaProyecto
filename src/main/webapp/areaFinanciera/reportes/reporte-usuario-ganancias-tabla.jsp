<%-- 
    Document   : reporte-usuario-ganancias-tabla
    Created on : 5/09/2021, 04:21:02 AM
    Author     : luis
--%>
            ...
            <section>
                <div class="ewk_cont_banner">
                    <div class="ewk_sombra">
                        <h1 class="text-center">REPORTE DEL USUARIO CON MÁS GANANCIAS</h1>
                        <a class="btn btn-success" href="Servlet-Reportes?accion=usuariog">Regresar</a>
                        <br>
                        <br>
                    ...
                    <% 
                        ...
                        List<Reporte>list=dao.usuarioGTabla(dao.usuarioG(ServletReportes.fechaInicio, ServletReportes.fechaFinal),ServletReportes.fechaInicio, ServletReportes.fechaFinal);
                ...
                <br>
                        <form class="form-group d-flex">
                            ...
                            <input class="col-sm-2 d-flex" class="text-center" type="text" value="<%=dao.usuarioG(ServletReportes.fechaInicio, ServletReportes.fechaFinal)%>" disabled="disabled"><br>
                        </form>
                        <form class="form-group d-flex">
                            <label class="text-black-50">Ganancia:</label>
                            <input class="col-sm-2 d-flex" class="text-center" type="text" value="<%=dao.gananciaUsuario(dao.usuarioG(ServletReportes.fechaInicio, ServletReportes.fechaFinal),ServletReportes.fechaInicio, ServletReportes.fechaFinal)%>" disabled="disabled"><br>
                        </form>
                <br>
                ...
                <script>
                    ...
                    btnExportToCsv.addEventListener("click", () => {
                        ...
                        anchorElement.download = "reporte-usuario-ganancias.csv";
                        anchorElement.click();
